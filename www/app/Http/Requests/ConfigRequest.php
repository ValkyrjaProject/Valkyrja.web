...
class ConfigRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'notification_channelid'             => 'required|integer',
            ...
            'antispam_joinrate_enabled'         => 'required|boolean',
            ...
            'delete_alert_regex'                => ['string', 'nullable', new LimitedRegExOrs(20)],
            'log_alert_regex'                   => ['string', 'nullable', new LimitedRegExOrs(30)],
            ...
            'native_gating'                     => 'required|boolean',
            'captcha'                           => 'required|boolean',
            'verify'                            => 'required|boolean',
            'verify_channelid'                  => 'required|integer',
            'ban_new_accounts'                  => 'required|boolean',
            ...
            'exp_ignored_channels'              => 'required|boolean',

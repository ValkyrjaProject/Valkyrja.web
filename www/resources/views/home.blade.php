...
<section class="container">
    <div class="media col-md-6 col-lg-4">
        <img src="/img/kara.png" alt="Jefi icon" class="media-object" style="width: 100%;"/>
    </div>
    <div class="col-md-6 col-lg-8">
        ...
        <p>
            ...
            This project exists thanks to an awesome team of contributors and volunteers who are not financially compensated. All the expenses are covered by <a href="https://github.com/sponsors/RheaAyase">GitHub</a> and <a href="https://www.patreon.com/ValkyrjaProject">Patreon</a> donations, and our own wallet, you know what to do should you wish to help out!
        </p>
    </div>
</section>
@endsection

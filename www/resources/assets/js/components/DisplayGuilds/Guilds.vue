    ...
    <div>
        ...
        <div class="message is-info">
            <div class="message-body">
                <div class="columns">
                    <div class="column">
                        Permissions required to be able to configure Valkyrja are <code>Administrator</code> & <code>ManageServer</code>, and you need to already have Valkyrja on your server before you can configure anything.
                    </div>
